...
def process_entries(entries):
    ...
    for entry in tqdm(entries, desc="Processing"):
        ...
        # Generate word audio with 1-second pause
        word_text = f"<speak><break time='1s'/>{new_entry['word']}</speak>"
        ...
        # Generate combined audio with 1-second pause + word + 1-second pause + sentence
        sentence_text = f"<speak><break time='1s'/>{new_entry['word']}. <break time='1s'/>{new_entry['example_en']}</speak>"
